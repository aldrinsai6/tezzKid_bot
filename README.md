...
Can be found on telegram as [ALENTIA](https://t.me/Xtra_Mega_bot)
).

The Support group can be reached out to at [ALENTIA Support](https://t.me/botzzilla), where you can ask for help about [ALENTIA](https://t.me/Xtra_Mega_bot)iscover/request new features, report bugs, and stay in the loop whenever a new update is available. 
